...
package com.veda.central.service.federated.cilogon;

import com.veda.central.core.commons.StatusUpdater;
import com.veda.central.core.mapper.federated.InstitutionMapper;
import com.veda.central.core.model.commons.OperationStatus;
import com.veda.central.core.model.commons.StatusEntity;
import com.veda.central.core.model.federated.CILogonInstitution;
import com.veda.central.core.repo.federated.CiLogonInstitutionCacheRepository;
import com.veda.central.service.exceptions.FederatedAuthenticationServiceException;
import com.veda.central.service.exceptions.InternalServerException;
import com.veda.central.service.federated.client.cilogon.CILogonClient;
import com.veda.central.service.federated.client.cilogon.CILogonResponse;
import org.apache.commons.lang3.StringUtils;
import com.veda.central.core.federated.authentication.api.CacheManipulationRequest;
import com.veda.central.core.federated.authentication.api.ClientMetadata;
import com.veda.central.core.federated.authentication.api.DeleteClientRequest;
import com.veda.central.core.federated.authentication.api.GetClientRequest;
import com.veda.central.core.federated.authentication.api.GetClientResponse;
import com.veda.central.core.federated.authentication.api.GetInstitutionsResponse;
import com.veda.central.core.federated.authentication.api.GetOperationsMetadataRequest;
import com.veda.central.core.federated.authentication.api.GetOperationsMetadataResponse;
import com.veda.central.core.federated.authentication.api.Institution;
import com.veda.central.core.federated.authentication.api.InstitutionCacheType;
import com.veda.central.core.federated.authentication.api.OperationMetadata;
import com.veda.central.core.federated.authentication.api.RegisterClientResponse;
...
public class FederatedAuthenticationService {
    ...
    public GetInstitutionsResponse getFromCache(CacheManipulationRequest request) {
        try {
            ...
            com.veda.central.service.federated.client.cilogon.CILogonInstitution[] ciLogonInstitutions = ciLogonClient.getInstitutions();

            if (institutions != null && !institutions.isEmpty()) {
                for (CILogonInstitution institution : institutions) {
                    for (com.veda.central.service.federated.client.cilogon.CILogonInstitution
    ...
    public GetInstitutionsResponse getInstitutions(CacheManipulationRequest request) {
        try {
            ...
            com.veda.central.service.federated.client.cilogon.CILogonInstitution[] ciLogonInstitutions = ciLogonClient.getInstitutions();
            List<com.veda.central.service.federated.client.cilogon.CILogonInstitution> selectedLists = new ArrayList<>();
            ...
            if (institutions.isEmpty() && blockedInstitutions.isEmpty()) {
                ...
                for (com.veda.central.service.federated.client.cilogon.CILogonInstitution ciLogonInstitution : ciLogonInstitutions) {
    ...
    public Institution convertCILogonToInstitution(com.veda.central.service.federated.client.cilogon.CILogonInstitution ciLogonInstitution) {
