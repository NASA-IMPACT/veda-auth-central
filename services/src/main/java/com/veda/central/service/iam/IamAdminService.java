...
import com.veda.central.core.iam.api.Agent;
import com.veda.central.core.iam.api.AgentClientMetadata;
import com.veda.central.core.iam.api.AllRoles;
import com.veda.central.core.iam.api.CheckingResponse;
import com.veda.central.core.iam.api.ConfigureFederateIDPRequest;
import com.veda.central.core.iam.api.DeleteExternalIDPsRequest;
import com.veda.central.core.iam.api.DeleteRoleRequest;
import com.veda.central.core.iam.api.DeleteTenantRequest;
...
import com.veda.central.core.iam.api.ExternalIDPLink;
import com.veda.central.core.iam.api.FederateIDPResponse;
import com.veda.central.core.iam.api.FindUsersRequest;
import com.veda.central.core.iam.api.FindUsersResponse;
import com.veda.central.core.iam.api.GetAllResources;
import com.veda.central.core.iam.api.GetAllResourcesResponse;
import com.veda.central.core.iam.api.GetExternalIDPsRequest;
import com.veda.central.core.iam.api.GetExternalIDPsResponse;
import com.veda.central.core.iam.api.GetOperationsMetadataRequest;
import com.veda.central.core.iam.api.GetOperationsMetadataResponse;
import com.veda.central.core.iam.api.GetRolesRequest;
import com.veda.central.core.iam.api.GroupRepresentation;
import com.veda.central.core.iam.api.GroupRequest;
import com.veda.central.core.iam.api.GroupsRequest;
import com.veda.central.core.iam.api.GroupsResponse;
import com.veda.central.core.iam.api.MapperTypes;
import com.veda.central.core.iam.api.OperationMetadata;
...
import com.veda.central.core.iam.api.ResourceTypes;
import com.veda.central.core.iam.api.RoleRepresentation;
import com.veda.central.core.iam.api.SetUpTenantRequest;
import com.veda.central.core.iam.api.SetUpTenantResponse;
import com.veda.central.core.iam.api.UpdateUserProfileRequest;
import com.veda.central.core.iam.api.UserAttribute;
import com.veda.central.core.iam.api.UserGroupMappingRequest;
...
public class IamAdminService {
    ...
    public SetUpTenantResponse setUPTenant(SetUpTenantRequest request) {
        try {
            ...
            KeycloakClientSecret clientSecret = keycloakClient.configureClient(String.valueOf(request.getTenantId()),
                    request.getVedaClientId(), request.getTenantURL(), request.getRedirectURIsList());
    ...
    public com.veda.central.core.iam.api.OperationStatus isUsernameAvailable(UserSearchRequest request) {
        try {
            ...
            return com.veda.central.core.iam.api.OperationStatus.newBuilder().setStatus(isAvailable).build();
    ...
    public com.veda.central.core.iam.api.OperationStatus isUserEnabled(UserSearchRequest request) {
        try {
    ...
    public com.veda.central.core.iam.api.UserRepresentation enableUser(UserSearchRequest request) {
        try {
            ...
            if (accountEnabled) {
                ...
                com.veda.central.core.iam.api.UserRepresentation user = getUser(representation, request.getClientId());
    ...
    public com.veda.central.core.iam.api.UserRepresentation disableUser(UserSearchRequest request) {
        try {
    ...
    public com.veda.central.core.iam.api.UserRepresentation getUser(UserSearchRequest request) {
        try {
    ...
    public FindUsersResponse findUsers(FindUsersRequest request) {
        try {
            ...
            List<com.veda.central.core.iam.api.UserRepresentation> users = new ArrayList<>();
            representation.forEach(r -> {
                ...
                if (status) {
                    ...
                    com.veda.central.core.iam.api.UserRepresentation user = this.getUser(r, request.getClientId());
    ...
    public com.veda.central.core.iam.api.OperationStatus resetPassword(ResetUserPassword request) {
        ...
        try {
            ...
            return com.veda.central.core.iam.api.OperationStatus.newBuilder().setStatus(isChanged).build();
    ...
    public com.veda.central.core.iam.api.OperationStatus deleteExternalIDPLinksOfUsers(DeleteExternalIDPsRequest request) {
        try {
            ...
            return com.veda.central.core.iam.api.OperationStatus.newBuilder().setStatus(status).build();
    ...
    public com.veda.central.core.iam.api.OperationStatus addExternalIDPLinksOfUsers(AddExternalIDPLinksRequest request) {
        try {
            long tenantId = request.getTenantId();
            ...
            return com.veda.central.core.iam.api.OperationStatus.newBuilder().setStatus(true).build();
    ...
    public com.veda.central.core.iam.api.OperationStatus updateUserProfile(UpdateUserProfileRequest request) {
    ...
    public com.veda.central.core.iam.api.OperationStatus deleteUser(UserSearchRequest request) {
        try {
            ...
            return com.veda.central.core.iam.api.OperationStatus.newBuilder().setStatus(isUpdated).build();
    ...
    public com.veda.central.core.iam.api.OperationStatus deleteRolesFromUser(DeleteUserRolesRequest request) {
        try {
    ...
    public RegisterUsersResponse registerAndEnableUsers(RegisterUsersRequest request) {
        try {
            ...
            List<com.veda.central.core.iam.api.UserRepresentation> userRepresentations = request.getUsersList();
            List<com.veda.central.core.iam.api.UserRepresentation> failedList = new ArrayList<>();

            for (com.veda.central.core.iam.api.UserRepresentation userRepresentation : userRepresentations) {
                try {
    ...
    public com.veda.central.core.iam.api.OperationStatus addRolesToUsers(AddUserRolesRequest request) {
        try {
    ...
    public com.veda.central.core.iam.api.OperationStatus deleteRole(DeleteRoleRequest request) {
        try {
            LOGGER.debug("Request received to add roles to tenant for " + request.getTenantId());
    ...
    public com.veda.central.core.iam.api.OperationStatus addProtocolMapper(AddProtocolMapperRequest request) {
        try {
    ...
    public com.veda.central.core.iam.api.OperationStatus addUserAttributes(AddUserAttributesRequest request) {
        try {
    ...
    public com.veda.central.core.iam.api.OperationStatus deleteUserAttributes(DeleteUserAttributeRequest request) {
        try {
    ...
    public com.veda.central.core.iam.api.OperationStatus configureEventPersistence(EventPersistenceRequest request) {
        try {
    ...
    public com.veda.central.core.iam.api.OperationStatus deleteGroup(GroupRequest request) {
        try {
    ...
    public com.veda.central.core.iam.api.OperationStatus addUserToGroup(UserGroupMappingRequest request) {
        try {
            LOGGER.debug("Request received to getAllGroups " + request.getTenantId());
    ...
    public com.veda.central.core.iam.api.OperationStatus removeUserFromGroup(UserGroupMappingRequest request) {
        try {
            LOGGER.debug("Request received to getAllGroups " + request.getTenantId());
    ...
    public com.veda.central.core.iam.api.OperationStatus configureAgentClient(AgentClientMetadata request) {
        try {
            LOGGER.debug("Request received to configureAgentClient " + request.getTenantId());
    ...
    public com.veda.central.core.iam.api.OperationStatus deleteAgent(UserSearchRequest request) {
        try {
    ...
    public com.veda.central.core.iam.api.OperationStatus disableAgent(UserSearchRequest request) {
        try {
    ...
    public com.veda.central.core.iam.api.OperationStatus isAgentNameAvailable(UserSearchRequest request) {
        try {
    ...
    public com.veda.central.core.iam.api.OperationStatus addAgentAttributes(AddUserAttributesRequest request) {
        try {
    ...
    public com.veda.central.core.iam.api.OperationStatus deleteAgentAttributes(DeleteUserAttributeRequest request) {
        try {
    ...
    public com.veda.central.core.iam.api.OperationStatus addRolesToAgent(AddUserRolesRequest request) {
        try {
    ...
    public com.veda.central.core.iam.api.OperationStatus deleteAgentRoles(DeleteUserRolesRequest request) {
        try {
    ...
    public com.veda.central.core.iam.api.OperationStatus enableAgent(UserSearchRequest request) {
        try {
    ...
    public com.veda.central.core.iam.api.OperationStatus grantAdminPrivilege(UserSearchRequest request) {
        try {
    ...
    public com.veda.central.core.iam.api.OperationStatus removeAdminPrivilege(UserSearchRequest request) {
        try {
    ...
    private com.veda.central.core.iam.api.UserRepresentation getUser(UserRepresentation representation, String clientId) {
        ...
        com.veda.central.core.iam.api.UserRepresentation.Builder builder = com.veda.central.core.iam.api.UserRepresentation.newBuilder()
