...
public class AttributeUpdateMetadataMapper {
     ...
     */
    public static com.veda.central.core.tenant.profile.api.TenantAttributeUpdateMetadata createAttributeUpdateMetadataFromEntity(TenantAttributeUpdateMetadata metadata) {

        return com.veda.central.core.tenant.profile.api.TenantAttributeUpdateMetadata.newBuilder()
