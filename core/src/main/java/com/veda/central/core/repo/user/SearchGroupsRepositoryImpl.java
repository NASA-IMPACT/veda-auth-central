...
public class SearchGroupsRepositoryImpl implements SearchGroupsRepository {
    ...
    @Override
    public List<Group> searchEntities(long tenantId, com.veda.central.core.user.profile.api.Group group, int offset, int limit) {
    ...
    private String createSQLQuery(long tenantId, com.veda.central.core.user.profile.api.Group group, Map<String, Object> valueMap, int offset, int limit) {
