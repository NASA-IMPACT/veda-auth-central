...
package com.veda.central.core.identity.authzcache;
...
public enum AuthzCachedStatus {
    ...
    /*Authorization decision is cached for the given authorization request and the decision authorizes the request.*/
    AUTHORIZED,
